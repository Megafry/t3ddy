...
Vagrant.configure("2") do |config|
  ...
  config.bindfs.bind_folder "/var/nfs", "/var/www/html/typo3conf/ext/t3ddy"
  config.bindfs.bind_folder "/var/nfs", "/var/www/html76/typo3conf/ext/t3ddy"
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    #{addComposerRequirement} "gridelementsteam/gridelements" "dev-master"
    ...
    #{addComposerAutoloader} "ArminVieweg\\\\T3ddy\\\\" typo3conf/ext/t3ddy/Classes/
    composer dump -o
  ...
  config.vm.provision "shell", inline: <<-SHELL
    ...
    #{addComposerRequirement} "helhum/typo3-console" "^4.5"
    #{addComposerRequirement} "gridelementsteam/gridelements" "^7.1"
